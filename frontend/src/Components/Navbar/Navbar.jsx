    ...
    <div className={styles.navbar}>
      ...
      <div className={`${styles.mobileMenu} ${showMobileMenu ? styles.active : ''}`}>
        {user ? <ul>
          ...
          <li onClick={toggleMenu}><Link to='/post'>WRITE</Link></li>
          <li onClick={handleLogout}><Link to='/login'>LOGOUT</Link></li>

        </ul> : <ul>
          <Link to='/login' onClick={toggleMenu} ><button className={styles.login} >Login</button></Link>
          <Link to='/register' onClick={toggleMenu} ><button className={styles.register}>Register</button></Link>
        </ul>}
      </div>
